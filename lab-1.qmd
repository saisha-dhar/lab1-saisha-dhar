...
ggplot(midwest, aes(x = percollege, y=popdensity, color=percbelowpoverty)) + geom_point(alpha = 0.5, size = 2) + facet_wrap(~state) + labs(x = "% college educated", y = "Population density (person/unit area)", color = "% below \n poverty line") + ggtitle("Do people with college degrees tend to live in denser areas?") + theme_minimal()
