...
#| label: generate-boxplot-of-area-of-counties-by-state

ggplot(midwest, aes(x = state, y = area, fill = state)) + 
  geom_boxplot() +
labs(x = "State", y = "Area of County", fill = "State") + 
...
```{r}
#| label: generate-segmented-bar-chart-of-counties-in-metro-by-state
